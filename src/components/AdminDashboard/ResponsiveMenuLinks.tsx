...
function ResponsiveMenuLinks({ showMenuLinks, setShowMenuLinks }: Props) {
  return (
    <Box
      ...
      className={`bg-[#F1F2F7] top-[7rem] left-0 z-10 absolute  h-[calc(100vh-10vh)] flex flex-col transition-all duration-500 ease-in-out gap-2 text-xl text-gray-500 md:hidden w-full py-0  `}
    >
      <LinksList
